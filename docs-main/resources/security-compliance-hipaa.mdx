...
5. Consider alternative secure channels for PHI communication title: 'New file' description: 'Description of your new file.'

## SOC 2 & Data Security & Compliance

MessageDesk is currently undergoing a SOC 2 audit, with completion slated for January 2026. 

To view our current security standards and protocols, please visit our [Trust Center](https://security.messagedesk.com/) and request access to view our security suite.
