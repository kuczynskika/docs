...
description: "What you can safely send by SMS, HIPAA do's and don'ts, where our HIPAA evaluation and BAA support stand, and how MessageDesk secures your data with SOC 2 Type II and our Trust Center."
sidebarTitle: "Data security, compliance & HIPAA"
og:title: "Data Security, Compliance & HIPAA - MessageDesk"
og:description: "What you can safely send by SMS, HIPAA do's and don'ts, where our HIPAA evaluation and BAA support stand, and how MessageDesk secures your data."
...
<Info>
  **HIPAA support is in progress.** We're working through a HIPAA compliance evaluation and expect to complete it by the **end of Q4 2026**. Once we do, we'll be able to provide a BAA to customers who need one.

  Until that work is finished, the guidance on this page stands: keep PHI off SMS. If a BAA is part of your buying decision, [talk to our team](/contact-us) so we can tell you where things stand and let you know when it's ready.
</Info>
...
**Will you sign a BAA?**\
Not today. Once our HIPAA evaluation is complete, planned for the **end of Q4 2026**, we'll be able to provide a BAA to customers who need one. [Contact us](/contact-us) if a BAA matters to your timeline and we'll keep you posted.
