---
title: 'Local docs development setup'
description: 'Install the Mintlify CLI, preview your MessageDesk documentation locally, manage versions, and troubleshoot common errors before publishing changes.'
---
