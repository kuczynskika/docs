---
title: 'Local Documentation Development Setup'
description: 'Install the Mintlify CLI to preview MessageDesk documentation changes locally, run a development server, and troubleshoot common setup issues.'
---
