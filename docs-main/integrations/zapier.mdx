...
description: "Automate SMS workflows by connecting MessageDesk to 9,000+ apps with Zapier. Triggers, actions, and recipe ideas for syncing CRM, forms, and ticketing tools."
...
| **Message Sent** | Fires when your workspace sends a message (manual or automated). |
...
| **New Form Submission → Create Comment with Mention** | Google Forms, Typeform | Automatically post a comment when a new form or chatbot submission arrives. |
...
| **Conversation Closed → Create Follow-Up Task** | Asana, ClickUp, Monday.com | When you close a MessageDesk conversation, create a follow-up task in your project management tool so nothing slips through after you resolve the thread. |
