---
title: "Zapier integration for MessageDesk (Beta)"
description: "Connect MessageDesk to thousands of apps using Zapier triggers and actions—send texts, create contacts, sync CRMs, and automate messaging workflows."
