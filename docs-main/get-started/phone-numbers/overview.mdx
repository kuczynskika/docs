...
<Note>
  **Verizon One Talk is not supported.** One Talk lines are tied to Verizon's mobile network and cannot be text-enabled with MessageDesk. See [Supported VoIP providers](/get-started/phone-numbers/landline-voip#supported-voip-providers) for alternatives.
</Note>
