...
**4. Start texting** Once approved and connected, you're ready to message from your [shared inbox](/inbox/overview).

<Note>
  **Twilio users:** You manage registration directly with Twilio. When you connect those numbers to MessageDesk, you generally don't need to register again—just connect and go.
</Note>
...
Learn more: [**Carrier Registration Overview**](/carrier-registration/overview) and [**Messaging Overview**](/messaging/overview)
