...
<Steps>
  <Step title="Download TestFlight on iOS" icon="download" stepNumber={1}>
    To join our beta, download TestFlight. [Download TestFlight here.](https://apps.apple.com/us/app/testflight/id899247664)
  </Step>
  <Step title="Download MessageDesk" icon="download" stepNumber={2}>
    Once the TestFlight app is downloaded to your device, click the button below to download the MessageDesk Inbox mobile app.

    import MySnippet from '/snippets/download-ios.mdx';
    
  </Step>
  <Step title="Start Texting and Leave Feedback" icon="hand" stepNumber={3}>
