...
description: "Create your first MessageDesk account and workspace in seconds"
---

## **\
Overview**

Signing up for MessageDesk and creating your workspace is simple.

### Identity verification requirements to get started:
...
<Steps>
  <Step title="Visit MessageDesk's sign up page" stepNumber={1}>
    If you're a new MessageDesk user and you haven't already created an account or received an invitation to an existing MessageDesk workspace, you can enter your email and a password to create an account.
    ...
    <Note>
      ...
      This personal phone number is just for account creation and user authentication/login purposes. It is not tied to your MessageDesk account or workspace.
