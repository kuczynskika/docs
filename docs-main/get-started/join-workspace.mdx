...
description: "Learn how to join an existing MessageDesk workspace via email invitation as a new team member."
---
...
<Warning>
  Sign up with the exact same email address that received the invitation (most likely your work or organization email). For example, if your original invitation came to **marty@pigeon.com**, make sure to sign up as **marty@pigeon.com**. Otherwise, you’ll create your own separate workspace.
</Warning>
