...
- **Sole proprietors with an EIN** require special manual verification through TCR (see FAQ below).
...
- **Sole Proprietor (no EIN)**
  ...
  - **Important**: This path is ONLY for sole proprietors without an EIN (SSN-only). If you have an EIN, you must use the Business (EIN) path with manual TCR verification.
...
- **For sole proprietors with an EIN**: W-9 and EIN letter from the IRS (required for manual TCR verification)
...
<AccordionGroup>
  ...
  <Accordion title=\"What if I'm a sole proprietor with an EIN?\" icon=\"question\" iconType=\"regular\">
    ### Sole proprietor with EIN registration process

    If you're a sole proprietor with an EIN, you cannot use the standard Twilio sole proprietor campaign or auto-verify through TCR, Telgorithm, or Bandwidth. You'll need manual verification through TCR.

    **What you need:**
    - W-9 showing your EIN
    - EIN letter from the IRS (official confirmation letter)
    - Business information matching your tax records

    **The process:**
    1. Provide your W-9 and EIN letter to MessageDesk support.
    2. We'll create your brand in TCR and open a support ticket with TCR.
    3. TCR will manually verify your brand as a private profit entity.
    4. Once verified, we can proceed with campaign submission.

    **Important notes:**
    - Without the EIN letter, your brand will remain unverified in TCR.
    - You cannot register as a sole proprietor inside TCR—you'll be verified as a private profit entity.
    - If you don't have your EIN letter, you can call the IRS directly to request another copy.

    **Alternative options:**
    - Convert your business to an LLC (through LegalZoom or other services). This updates your business structure and eliminates the need for the EIN letter—you'll just need an updated W-9.
    - If you don't have an EIN and only use your SSN, you can use the standard Sole Proprietor (no EIN) registration path without issues.
  </Accordion>
</AccordionGroup>
