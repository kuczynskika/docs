...
- **Import templates.** Upload a CSV of templates and map columns to name, body, tags, and media. Templates that match an existing template by **name** are updated in place. See [Import message templates](/settings/workspace-settings/data-center#import-message-templates).
