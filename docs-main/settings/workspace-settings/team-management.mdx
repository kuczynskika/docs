...
<Warning>
  **Who can delete messages from a conversation thread?**
  ...
  To stop a user from deleting messages in a thread, make sure they **don't have Owner permission** on the phone line. Adjust their role or use a [custom role](#custom-roles-and-permissions) to grant **Editor**, **Viewer**, or **No Access** on the relevant **Phone number inboxes**.
</Warning>
