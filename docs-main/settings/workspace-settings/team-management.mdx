...
<Warning>
  **Who can delete messages from a conversation thread?**
  ...
  If you don't want a user to be able to delete messages from a conversation thread, make sure that user **doesn't have Owner permission** on the phone line. Adjust their role or use a [custom role](#custom-roles-and-permissions) to grant **Editor**, **Viewer**, or **No Access** on the relevant **Phone number inboxes**.
</Warning>
