...
Click **Export** to download a CSV of the current view. Use CSV exports for **data analysis, reporting, and bulk archiving**.
...
- **From a conversation:** Open the conversation in the Inbox and choose **Export to PDF** from the conversation menu.
