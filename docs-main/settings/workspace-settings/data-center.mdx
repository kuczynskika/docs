...
description: "Import contacts and historical SMS messages, then search, filter, and export your full MessageDesk message history—all from the Data Center."
...
- You can map **[custom fields](/settings/workspace-settings/custom-fields)** (ensure the CSV data type matches the field type).
