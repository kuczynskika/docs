...
<Note>
  Call forwarding currently works on **Bandwidth** and **Telgorithm** phone lines. **Twilio** call forwarding is temporarily off while we finalize additional configuration, and we'll re-enable it in an upcoming release.
</Note>
