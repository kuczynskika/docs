...
{/* TODO (human review): this section has only a screenshot. Add a one-line description of what call forwarding does and how to enable it. */}
...
### Call forwarding events/notes in message threads
