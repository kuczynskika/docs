...
# Manage Connected Phone Lines \+ Naming/Organization & Call Forwarding
...
<Tip>
  You can also edit the name of a phone line from your **inbox**. Hover over a phone line, click the **three dots (more) icon,** and then click **Rename or select another option**.
