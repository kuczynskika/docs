...
<Note>
  Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, please contact support@messagedeks.com, and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, please contact [support@messagedeks.com](mailto:support@messagedeks.com), and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-Connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis. Call forwarding works on most MessageDesk-connected phone lines. You can't configure call forwarding in-app for **Twilio-connected** numbers today. The setup process is different for Twilio numbers. If you need forwarding, contact [support@messagedesk.com](mailto:support@messagedesk.com) and we'll configure it manually on a per-number basis.
</Note>
