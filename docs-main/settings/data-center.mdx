---
title: "Import contacts and export message history"
description: "Use the Data Center to bulk import contacts and historical messages from CSV, then search, filter, and export your full MessageDesk message history."
