---
title: "Create custom fields for contacts"
description: "Add custom contact fields to MessageDesk—text, date, dropdown, and more—to track region, role, renewal date, or any data you need for filters and templates."
