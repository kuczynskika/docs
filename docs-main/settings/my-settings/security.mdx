...
### "Invalid session for the user, session expired."

You'll see this error if you sit on the **sign-in / authentication page for more than 3 minutes** before completing sign-in. The sign-in session itself times out for security.

To fix it:

1. **Sign out completely** (close the sign-in page or click **Sign out** if you're partially authenticated).
2. Open the sign-in page fresh and **sign in without pausing** — enter your credentials and complete two-factor authentication within 3 minutes.

<Tip>
  If you're waiting for a **verification code** to arrive by email or SMS, request it, watch for it, and enter it right away. If the code takes more than a couple of minutes to arrive, sign out and start again rather than waiting on the auth page.
</Tip>
