...
You'll see this error if you sit on the **sign-in / authentication page for more than 3 minutes** before completing sign-in. The sign-in session times out for security.
