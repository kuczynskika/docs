...
<Note>
  Mobile push notifications include **sound and vibration** when a new message arrives. These are controlled by your device's notification settings, not by MessageDesk. Manage them in:
