...
**Can you delete a custom user role after creating it?**

No. You can't currently delete custom user roles. Updates are planned that will allow users to delete user roles.
