...
Relays are **grouped by Trigger** (Message Received, Message Sent, Comment Created, Conversation Closed) and, within each group, **sorted by Order**. You can scan every Relay on a phone line or event at a glance.
