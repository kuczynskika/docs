...
The list **groups Relays by Trigger** (Message Received, Message Sent, Conversation Opened, Conversation Users Assigned, Conversation Label Applied, Comment Created, Conversation Closed) and, within each group, **sorts them by Order**. You can scan every Relay on a phone line or event at a glance.
...
The available conditions depend on the selected trigger. The message triggers (Message Received and Message Sent) add **Message contains text**, Comment Created adds **Comment contains text**, and every trigger includes the universal six: **My phone number equals**, **Conversation label equals**, **Is anonymous conversation**, **Is new conversation**, **Is unassigned conversation**, and **Active hours**.
