...
- **Send Message:** send an outbound SMS/MMS on non-conversation triggers. New in **v2026.08.11**. Because there's no existing conversation to reply into, the action asks you to pick an **Outbound Channel** (which connected phone number to send from). Currently available on the **Contact Updated** trigger.
