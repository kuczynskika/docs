...
<Note>
  **Permissions required:** By default, only **Admin** users have access to Relays. Admins can grant **Relay Management** permissions to other user roles via **Settings → Team Management**. Learn more: [Team Management](/settings/workspace/team-management).
</Note>
