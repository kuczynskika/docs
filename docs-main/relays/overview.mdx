...
- **Triggers:** When it runs\
  _Examples:_ `MessageReceived` (a new inbound text starts the relay), `CommentCreated` (a teammate posts an internal comment), `ConversationClosed` (a teammate closes a conversation)
