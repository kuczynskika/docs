...
- **Triggers:** When it runs\
  _Examples:_ `MessageReceived` (a new inbound text starts the relay), `MessageSent` (an outbound message is sent from your workspace), `CommentCreated` (a teammate posts an internal comment), `ConversationClosed` (a teammate closes a conversation)
