...
| **Actions** | Update Contact Property (set a **Text** property from the payload using **Event Data**) |

**Why it works:** When a value changes in another system, the webhook updates the matching contact property in MessageDesk automatically.
