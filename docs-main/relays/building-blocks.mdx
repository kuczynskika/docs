...
**Conversation Label Removed** supports the same set as Message Failed with one asymmetry: **Remove labels from the conversation is not available** on this trigger. Every other action above is available.
