...
<Note>
  **Developer Tools required:** Before using webhooks, you need to configure your webhook endpoint and generate a signing secret in [**Settings → Developer Tools**](/settings/workspace-settings/developer-tools).
</Note>
