...
<Note>
  **Plan required:** Outbound webhooks are available on the **Pro** and **Enterprise** plans, and they run as a Relay action, so they follow the same plan requirement as [Relays](/relays/overview). See [Pricing](/resources/pricing).
</Note>
