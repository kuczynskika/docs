---
title: "Send webhooks from a Relay action"
description: "Push MessageDesk events to any HTTPS endpoint with the Send Webhook Relay action—configure URLs, headers, payload signing, and integrate external systems."
