...
<Tip>
  Reopens are handled automatically: a new inbound message on a closed conversation reopens the thread and fires any **Conversation Opened** Relays you've configured (see [Recipe 9](#9-re-triage-on-reopen)).
</Tip>
