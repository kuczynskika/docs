...
<AccordionGroup>
  <Accordion title="Will there be any downtime?">
  ...
  <Accordion title="Do my contacts move automatically?">
  ...
  <Accordion title="Does my conversation history migrate?">
    No. We can place your MessageDesk Reach account on a free, active subscription, allowing you to reference previous conversation data.
  </Accordion>
