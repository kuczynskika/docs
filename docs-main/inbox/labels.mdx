...
"og:description": "Learn how to create labels, label conversations, and manage labels across your entire MessageDesk workspace."
...
<Tip>
  **Tip:** You can **multi-select** labels and **delete them in bulk** from Label Settings—no need to remove them one at a time.
</Tip>

<Note>
  **Label order:** Labels are sorted **alphabetically (A–Z)** by name across label menus, settings, and filters. To control where a label appears, rename it (e.g., add a prefix like `HR:` or `Support:`).
</Note>
...
Yes. Edit the name/color/icon anytime from **Inbox (Label menu)** or **Workspace Settings**. Deleting a label removes it from all conversations. You can also multi-select and delete multiple labels at once from **Label Settings**.
