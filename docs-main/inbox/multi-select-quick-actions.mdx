---
title: "Bulk actions: multi-select conversations"
description: "Select multiple SMS conversations at once to assign, label, close, or apply other quick actions in bulk—from any sorted, filtered, or saved inbox view."
sidebarTitle: "Multi-select quick actions"
"og:title": "Multi-Select Quick Actions - Bulk Conversation Management"
"og:description": "Learn how to quickly select and apply actions to multiple conversations at once."
