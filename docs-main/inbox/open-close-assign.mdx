...
"og:description": "Learn how to manage conversation state with open, closed, and assignment."
...
- **Automatic:** Any **new inbound message** received in a closed thread reopens it and marks it **Unread** in **Open Inbox**. Sending an outbound message does not reopen the conversation.

![Inbox Reopen Conversation Pn](/docs-main/images/inbox-reopen-conversation.png)

<Note>
  By default, any new inbound message received within a closed conversation thread will reopen that conversation in the Open Inbox and display an unread icon next to the conversation. Outbound messages do not reopen closed conversations.
</Note>
...
No. You can reopen any time manually. A new inbound message also reopens the thread automatically.
...
- **My closed thread didn’t reopen after activity.**\
  Only inbound messages reopen closed conversations. Sending an outbound message does not change the conversation state. To reopen manually, navigate to **Closed Inbox**, select the thread, and click **Open**.
