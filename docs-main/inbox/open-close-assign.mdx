...
> **Best practice:** Close a thread once the request is resolved or no action is needed.
...
Use assignment to make ownership clear and avoid double work.
...
- **Leave a comment on handoff.** Summarize the situation and next step.
