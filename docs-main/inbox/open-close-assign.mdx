...
You can also use the **Assignee** filter to show only **Unassigned** conversations — threads that don't have an owner yet. See [Filter, search & sort](/inbox/filter-search-sort) for details.
