...
- **Relays.** Triggered workflows tied to your workspace.
...
- **Message timestamps.** Messages sent earlier the same day display a relative time (for example, "5 minutes ago"). Once a message is from a previous day, the thread shows the actual time it was sent instead.
