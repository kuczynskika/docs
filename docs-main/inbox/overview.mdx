...
- **Message timestamps.** Messages sent earlier the same day show a relative time (for example, "5 minutes ago"). Messages from a previous day show the actual send time instead.
