...
<Note>
  **Looking for search?** Global and advanced search now live in the new [Search](/search/overview) section. Use [Quick Search](/search/quick-search) (⌘K) for contacts and conversations, or [Advanced Search](/search/advanced-search) for messages, comments, labels, and more.
</Note>

This page focuses on **filtering** your Inbox by label, assignee, or workspace phone, and **sorting** the resulting list.
...
To search **messages**, **comments**, or **labels**, open [Advanced Search](/search/advanced-search)—either from within Quick Search (press **Enter** on a result, click the search icon, or click **Open Advanced Search**) or from the search icon on mobile and tablet.
...
- Sort: Waiting Longest
- Goal: Assign ownership to conversations that haven't been claimed yet
...
The filters on this page apply to the **live Inbox**. To search, filter, and export your workspace's full message archive, see [**Data Center → Message History**](/settings/data-center#message-history).
