...
The filters and search on this page apply to the **live Inbox**. To search, filter, and export your workspace's full message archive, see [**Data Center → Message History**](/settings/workspace-settings/data-center#message-history).
