---
title: "Documentation site quickstart"
description: "Clone the docs repo, preview locally with the Mintlify CLI, customize your site name and colors, and deploy your first changes in just a few steps."
---
