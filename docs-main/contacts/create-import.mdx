...
description: "Create, edit, delete, filter, and CSV-import contacts in MessageDesk. Includes required field formats, validation rules, deduping, and import limits."
