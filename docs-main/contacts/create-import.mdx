...
1. Go to **Contacts**.
2. Find and select the contact(s) you want to delete. Multi-select is always available in the Contacts module — click any contact row to add it to your selection.
3. Click the **trash can icon** in the multi-select toolbar to delete the selected contact(s).
...
<Frame>
  ![Contacts Delete 1](/images/contacts-delete-1.png)
</Frame>

### Adjust contacts per page

Use the page size selector at the bottom of the Contacts list to show **25**, **50**, **100**, or **250** contacts per page.
