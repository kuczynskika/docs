...
<Frame>
  <img
    src="/images/contacts-detail.png"
    alt="Contacts Detail"
...
1. Open the saved filter from the Contacts side menu.
2. Click the **delete** option to remove the filter.
3. Confirm the deletion when prompted.

<Note>
  Saved filters **cannot be edited** after creation. To modify a filter, create a new filter with the updated criteria and save it as a new filter.
</Note>
...
Click **\+ Add Custom Property** to map custom properties from your .csv file to custom properties in MessageDesk.
