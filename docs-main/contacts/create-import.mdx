...
<Note>
  Saved filter search is available on the **desktop web app only**. It is not available on tablet or mobile, since filters cannot currently be managed in Contacts on those platforms.
</Note>
