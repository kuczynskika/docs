...
description: "Understand how MessageDesk handles anonymous, opted-out, and blocked contacts—what each status means, where to find them, and how to manage each list."
