...
## Viewing Scheduled Messages in the Conversation Thread
...
![Scheduled Messages Inbox View](/images/scheduled-messages-inbox-view.png)
...
![Scheduled Messages Filter](/images/scheduled-messages-filter.png)
...
The Scheduled view shows all schedules by default. Use the **Schedules Filter** to select your name and see only schedules you created.
