---
title: "Schedule text messages for later"
description: "Schedule SMS, MMS, group texts, and broadcasts to send minutes, days, or months ahead, then edit or cancel any pending message from your MessageDesk inbox."
sidebarTitle: "Scheduled messages"
---

# Learn How to Schedule Text Messages in MessageDesk
...
![Schedule A Message](/images/schedule-a-message.png)

![Scheduled Messages Date Time Picker](/images/scheduled-messages-date-time-picker.png)
...
## View & Edit Scheduled Messages in the Conversation Thread

Scheduled messages now appear directly in your message thread, so you can see what's queued without leaving the conversation.
...
![View Scheduled Messages](/images/view-scheduled-messages.png)

<Frame>
  ![Scheduled Messages Inline Edit](/images/scheduled-messages-inline-edit.png)
</Frame>
...
![Scheduled Mesages Actions](/images/scheduled-mesages-actions.png)

![Scheduled Messages View](/images/scheduled-messages-view.png)
...
![Scheduled Messages Filter Advanced](/images/scheduled-messages-filter-advanced.png)
