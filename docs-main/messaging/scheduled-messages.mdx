...
- When scheduled messages are pending, a **banner** above the Message Compose box shows how many.
...
- **Opt-outs:** If a contact **opts out** before the scheduled time, that send **won't** deliver to that contact.
