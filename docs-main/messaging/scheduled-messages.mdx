...
description: "Schedule SMS messages in MessageDesk for any future date and time, then edit, cancel, or reschedule them from your inbox before they send."
...
![Scheduled Messages Actions](/images/scheduled-messages-actions.png)
