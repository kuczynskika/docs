...
3. **Check the basics.** Is the number **mobile** and [formatted **E.164**](/contacts/create-import) (`+15551234567`)?
4. **Registration matters.** Make sure your line is [**A2P 10DLC-registered**](/carrier-registration/overview) (local) or **verified** (toll-free).
5. **If urgent, use another channel** (call/email) while you troubleshoot.

![Messages Failed Pn](/docs-main/images/messages-failed.png)

![Messages Error Message Pn](/docs-main/images/messages-error-message.png)
...
3. **Throughput or registration limits**
   ...
   - Fix: Complete [**10DLC**](/carrier-registration/overview) or **toll-free verification**. **Schedule** large sends in waves. Contact support if suspended.
...
| **2**  | Invalid Number          | Landline/invalid/typo.      | Use a **mobile** number; fix number [formatting to **E.164**](/contacts/create-import).                  |
| **3**  | Invalid Message         | Content blocked.            | Remove blocked phrases/formatting; comply with campaign terms; resend.        |
| **4**  | Anti-spam               | Filtered as spam.           | Add opt-out, reduce links/ALL-CAPS; segment; ensure [**10DLC**](/carrier-registration/overview).                |
...
| **14** | Unregistered 10DLC      | Local number unregistered.  | [Register brand/campaign](/carrier-registration/overview); resend post-approval.                                |
