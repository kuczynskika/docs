---
title: "SMS, MMS & Group Messaging Overview"
description: "Explore the messaging types MessageDesk supports: 1:1 SMS, MMS, group texts, scheduled sends, and templated broadcasts. Plus throughput and channel rules."
...
MessageDesk sends and receives over standard carrier SMS and MMS. It doesn't use Apple iMessage.

- iMessage is Apple's separate, proprietary protocol. iMessage conversations don't appear in the MessageDesk shared Inbox.
- Messages from iPhone users still reach you. When you or a contact texts a MessageDesk number, carriers deliver the message as SMS/MMS and it shows up in the Inbox normally. You just won't see blue-bubble iMessage threads.
- You can't connect an existing cellular or mobile line to MessageDesk while it stays with its wireless carrier. If your team wants to share texting on a personal cell, use a separate MessageDesk business number. Add [call forwarding](/settings/workspace-settings/phone-management#call-forwarding) to a cell if voice matters. See [Phone numbers](/get-started/phone-numbers/overview) to add or connect a line.
...
Private, one-to-one messages with a single contact. Each conversation is its own thread in your shared inbox. Your team gets full context and can assign, filter, and follow up without stepping on each other.
...
Send one message to many contacts at once. Replies come back as **private 1-on-1** threads so you can triage and follow up quickly. (This is why broadcasts scale _and_ stay personal.)

<Note>
  **Plan required:** Unlimited 100-person text broadcasts are available on the **Pro** and **Enterprise** plans. See [Pricing](/resources/pricing).
</Note>
...
![SMS broadcast compose screen with multiple recipients and Send Individually selected](/images/CleanShot2025-09-18at11.07.54@2x.png)
...
![A group conversation thread in the MessageDesk Inbox](/images/CleanShot2025-09-18at11.05.48@2x.png)
