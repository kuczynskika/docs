...
- Combine with [templates and scheduling](/relays/overview) for speed.

**Limitations:**

- Currently limited to **100 contacts per send**.
- Best for one-way notices; not for group collaboration.
- Be mindful of [consent and opt-out](/carrier-registration/overview) language for non-conversational texts.

<Note>
  **Pro tip:** [Segment first](/contacts/create-import). Targeted broadcasts get better engagement and fewer opt-outs.
</Note>
