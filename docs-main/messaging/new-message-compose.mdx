...
- **Message** – your text, plus options for template, media, emoji
...
- **Apply a template** to save time and maintain consistent wording.
- **Add media (MMS)** to include images, PDFs, or other supported files.
