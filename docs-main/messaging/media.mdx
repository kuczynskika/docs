...
- **HEIC** (common on iPhone) uploads are accepted, but for the most reliable MMS delivery and in-app preview we recommend exporting photos as **.jpg** or **.png** before sending. See [HEIC photo handling](#heic-photo-handling) below.
...
HEIC is the default photo format on newer iPhones. You can attach HEIC files in MessageDesk, but there are a few things to know about how they're delivered and previewed:
