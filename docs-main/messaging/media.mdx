...
description: "Send and receive images, GIFs, videos, PDFs, and contact cards over MMS in MessageDesk—plus supported file types, size limits, and reuse from your library."
sidebarTitle: "Media"
