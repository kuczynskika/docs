...
description: "Avoid SMS rejections by understanding restricted SHAFT-C content: sex, hate, alcohol, firearms, tobacco, and cannabis. Stay compliant with carrier rules."
...
- Illegal substances (cannabis/marijuana, prescription drugs not OTC, vaping; CBD isn't permitted by US carriers).
...
- Simple checkboxes stating "I am 21+" aren't sufficient.

**Prohibited messaging content:**
Even with proper age-gating in place, carriers block messages containing promotional keywords related to alcohol purchases. Don't send messages with phrases like:
- "Buy XYZ beer"
- "Liquor sale"
- "Purchase wine"
- Similar direct purchase language for alcoholic beverages

These keywords trigger carrier-level delivery issues and result in message filtering or blocking, regardless of your registration status.
