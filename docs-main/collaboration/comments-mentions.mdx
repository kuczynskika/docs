...
<Note>
  You can click the + button to add media/images to comments as well!
</Note>
...
Once you comment posts, each MessageDesk user you've mentioned in your comment will receive an email notification. This notification will direct them directly to the inbox where the comment and text thread are located.
